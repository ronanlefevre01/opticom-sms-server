...
class Api {
    ...
    signApiRequest(path, requestOptions) {
        const body = requestOptions.json !== null && requestOptions.json !== undefined
            ...
            : undefined;
        const contentDigest = body !== undefined ? apiRequestSigning_1.ApiRequestSignatureHelper.getSha256Digest(body) : undefined;
        const contentLength = body !== undefined ? Buffer.byteLength(body, 'utf8') : undefined;
        const signer = new apiRequestSigning_1.ApiRequestSignatureHelper({
        ...
        return {
            ...
            headers: {
                ...
                'Content-Digest': contentDigest ? apiRequestSigning_1.ApiRequestSignatureHelper.getSha256DigestHeader(contentDigest) : undefined,
            },
        };
    }
